...
**SlipSense** คือแอปพลิเคชันจัดการการเงินบน iOS ที่ออกแบบมาเพื่อเปลี่ยนสลิปโอนเงินในคลังรูปภาพของคุณให้กลายเป็นข้อมูลรายรับ-รายจ่ายแบบอัตโนมัติ ด้วยพลังของ AI (OCR) พร้อมแดชบอร์ดสรุปพฤติกรรมการใช้จ่ายที่เข้าใจง่าย สวยงาม และที่สำคัญคือ **ปลอดภัย 100%** เพราะข้อมูลทั้งหมดถูกประมวลผลและจัดเก็บไว้ภายในเครื่องของคุณเท่านั้น


https://github.com/user-attachments/assets/e163ed2b-9cb2-4b7b-80b9-2dd065468e04
